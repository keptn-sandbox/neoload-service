...
public  class EventType {
    ...
    public static final String KEPTN_NEW_ARTIFACT="sh.keptn.events.new-artefact";
    public static final String KEPTN_CONFIGURATION_CHANGED="sh.keptn.events.configuration-changed";
